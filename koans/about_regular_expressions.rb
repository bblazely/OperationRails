...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
	# Answer: No ? specified, so they will match from first occurance to last occurance + everything in between. Hence greedy. Redefine as ab*? (i think?) to make them lazy.
  ...
  def test_variables_can_also_be_used_to_access_captures
    assert_equal "Gray, James", "Name:  Gray, James"[/(\w+), (\w+)/]  # BB - don't follow this one. expected an array
    assert_equal "Gray", $1
