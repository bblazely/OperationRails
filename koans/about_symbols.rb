...
# BB Unsure, but hypothesis is that calling the comparrison as anything other than a string, in this case may eval the function represented by the symbol 'test_method_names_become_symbols' ? Research!
...
# BB Symbols are not subject (in most cases) to automatic garbage collection?
end
