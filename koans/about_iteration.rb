...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
	...
	# BB. Inject iterates over all keys, each iteration also has access to the result of the previous iteration. funky
  end
  ...
  #   # code to read 'file'
  #   BB Suspect it's something to do with not using a temporary variable to store the file handle. GC related? intruiging!
  #
